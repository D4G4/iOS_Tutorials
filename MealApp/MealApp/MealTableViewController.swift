...
class MealTableViewController: UITableViewController {
    ...
    @IBAction func unwindToMealList(sender: UIStoryboardSegue) {
        ...
        if let mealViewController = sender.source as? MealViewController, let meal = mealViewController.meal {
    ...
    /// - returns: Just MealTableViewCell fro now
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {

        let cellIdentifier = "MealTableViewCell"

        //dequeueReusableCell -> requests a cell from the table view.
        guard let mealTableViewCell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? MealTableViewCell else {
